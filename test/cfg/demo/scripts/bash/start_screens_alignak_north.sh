...
screen -d -S alignak_north_broker -m bash -c "alignak-broker -c /usr/local/etc/alignak/arbiter/packs/demo/daemons/brokerd-north.ini"
screen -d -S alignak_north_poller -m bash -c "alignak-poller -c /usr/local/etc/alignak/arbiter/packs/demo/daemons/pollerd-north.ini"
screen -d -S alignak_north_scheduler -m bash -c "alignak-scheduler -c /usr/local/etc/alignak/arbiter/packs/demo/daemons/schedulerd-north.ini"
screen -d -S alignak_north_receiver -m bash -c "alignak-receiver -c /usr/local/etc/alignak/arbiter/packs/demo/daemons/receiverd-north.ini"
sleep 1
