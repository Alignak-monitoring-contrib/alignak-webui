...
screen -d -S north_alignak_broker -m csh -c "alignak-broker -c /usr/local/etc/alignak/daemons/brokerd-north.ini"
screen -d -S north_alignak_poller -m csh -c "alignak-poller -c /usr/local/etc/alignak/daemons/pollerd-north.ini"
screen -d -S north_alignak_scheduler -m csh -c "alignak-scheduler -c /usr/local/etc/alignak/daemons/schedulerd-north.ini"
screen -d -S north_alignak_receiver -m csh -c "alignak-receiver -c /usr/local/etc/alignak/daemons/receiverd-north.ini"
sleep 1
