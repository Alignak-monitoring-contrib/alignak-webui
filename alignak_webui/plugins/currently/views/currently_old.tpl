         ...
         <div class="panel panel-default">
            <div class="panel-heading clearfix">
               ...
               <div class="pull-right">
                  <a href="#p_panel_counters_hosts" data-toggle="collapse" class="btn btn-xs btn-raised"><i class="fa {{'fa-caret-up' if not currently_panels['panel_counters_hosts']['collapsed'] else 'fa-caret-down'}} fa-fw"></i></a>
               </div>
            </div>
      ...
      <div class="col-md-6" id="panel_counters_services">
         <div class="panel panel-default">
            <div class="panel-heading">
               ...
               <div class="pull-right">
                  <a href="#p_panel_counters_services" data-toggle="collapse" class="btn btn-xs btn-raised"><i class="fa {{'fa-caret-up' if not currently_panels['panel_counters_services']['collapsed'] else 'fa-caret-down'}} fa-fw"></i></a>
               </div>
             </div>
      ...
      <div class="col-md-6" id="panel_percentage_hosts">
         <div class="panel panel-default">
            <div class="panel-heading">
               ...
               <div class="pull-right">
                  <a href="#p_panel_percentage_hosts" data-toggle="collapse" type="button" class="btn btn-xs btn-raised"><i class="fa {{'fa-caret-up' if not currently_panels['panel_percentage_hosts']['collapsed'] else 'fa-caret-down'}} fa-fw"></i></a>
               </div>
            </div>
      ...
      <div class="col-md-6" id="panel_percentage_services">
         <div class="panel panel-default">
            <div class="panel-heading">
               ...
               <div class="pull-right">
                  <a href="#p_panel_percentage_services" data-toggle="collapse" type="button" class="btn btn-xs btn-raised"><i class="fa {{'fa-caret-up' if not currently_panels['panel_percentage_services']['collapsed'] else 'fa-caret-down'}} fa-fw"></i></a>
               </div>
            </div>
         ...
         <div class="panel panel-default">
            <div class="panel-heading">
               ...
               <div class="pull-right">
                  ...
                  <a href="#p_panel_pie_graph_hosts" data-toggle="collapse" type="button" class="btn btn-xs btn-raised"><i class="fa {{'fa-caret-up' if not currently_panels['panel_pie_graph_hosts']['collapsed'] else 'fa-caret-down'}} fa-fw"></i></a>
               </div>
            </div>
         ...
         <div class="panel panel-default">
            <div class="panel-heading">
               ...
               <div class="pull-right">
                  ...
                  <a href="#p_panel_pie_graph_services" data-toggle="collapse" type="button" class="btn btn-xs btn-raised"><i class="fa {{'fa-caret-up' if not currently_panels['panel_pie_graph_services']['collapsed'] else 'fa-caret-down'}} fa-fw"></i></a>
               </div>
            </div>
      ...
      <div class="col-md-6" id="panel_line_graph_hosts">
         <div class="panel panel-default">
            <div class="panel-heading">
               ...
               <div class="pull-right">
                  <a href="#p_panel_line_graph_hosts" data-toggle="collapse" type="button" class="btn btn-xs btn-raised"><i class="fa {{'fa-caret-up' if not currently_panels['panel_line_graph_hosts']['collapsed'] else 'fa-caret-down'}} fa-fw"></i></a>
              </div>
            </div>
      ...
      <div class="col-md-6" id="panel_line_graph_services">
         <div class="panel panel-default">
            <div class="panel-heading">
               ...
               <div class="pull-right">
                  <a href="#p_panel_line_graph_services" data-toggle="collapse" type="button" class="btn btn-xs btn-raised"><i class="fa {{'fa-caret-up' if not currently_panels['panel_line_graph_services']['collapsed'] else 'fa-caret-down'}} fa-fw"></i></a>
               </div>
            </div>
...
<script type="text/javascript">
   ...
   // Graphs options
   $('[data-action="toggle-title"]').on('click', function (e) {
      wait_message('{{_('Saving configuration...')}}', true)
   ...
   $('[data-action="toggle-state"]').on('click', function (e) {
      wait_message('{{_('Saving configuration...')}}', true)
