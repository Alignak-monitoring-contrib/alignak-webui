...
class HostEscalation(BackendElement):
    """Object representing a hostescalation"""
    _count = 0
    # Next value used for auto generated id
    _next_id = 1
    # _type stands for Backend Object Type
    _type = 'hostescalation'
    # _cache is a list of created objects
    _cache = {}

    def __init__(self, params=None, date_format='%a, %d %b %Y %H:%M:%S %Z', embedded=True):
        """Create an hostescalation (called only once when an object is newly created)"""
        ...
        super(HostEscalation, self).__init__(params, date_format, embedded)
