...
class BackendGraphite(BackendElement):
    ...
    def __init__(self, params=None, date_format='%a, %d %b %Y %H:%M:%S %Z', embedded=True):
        ...
        self._linked_grafana = 'grafana'
        self._linked_statsd = 'statsd'

        super(BackendGraphite, self).__init__(params, date_format, embedded)

    @property
    def _realm(self):
        """Return concerned object"""
        return self._linked__realm

    @property
    def grafana(self):
        """Return concerned object"""
        return self._linked_grafana

    @property
    def statsd(self):
        """Return concerned object"""
        return self._linked_statsd
